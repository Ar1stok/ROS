...
class DynamicFrameBroadcaster(Node):
    ...
    def broadcast_timer_callback(self):
        ...
        t.transform.translation.x = radius * math.sin(x / 1e9 * rotation)
        t.transform.translation.y = radius * math.cos(x / 1e9 * rotation)
